...
function memoryLoad()
{
	console.log('MemoryLoad: '+Math.floor((os.totalmem() - os.freemem())*100/ os.totalmem())+'%');
	return Math.floor((os.totalmem() - os.freemem())*100/ os.totalmem());
...
function cpuAverage()
{
	...
	var totalDifference = endMeasure.total - startMeasure.total;
 	...
 	console.log('CPULoad: '+Math.floor((1-(idleDifference/totalDifference))*100)+'%');
	//Calculate the average percentage CPU usage
	return Math.floor((1-(idleDifference/totalDifference))*100);
...
function measureLatenancy(server)
{
	...
	{	
		...
		server.latency = stopTime - startTime;
	});
